...
const translations = {
  ar: {
    ...
    hero_trust_badge: "خبرة معتمدة +25 عاماً بالمملكة",
    ...
    hero_description_exact: "مدير تطوير عقاري ومعماري بخبرة تتجاوز 25 عامًا في قيادة المشاريع الكبرى من التصميم والتخطيط إلى التنفيذ والتسليم بالمملكة العربية السعودية.",
    hero_btn_projects_exact: "استعرض المشاريع",
    hero_btn_contact_exact: "اطلب استشارة",
    proof_exp: "+25 عامًا من الخبرة",
    ...
    timeline_title: "مسار الريادة والتطور الهندسي عبر 25 عاماً",
  ...
  en: {
    ...
    hero_trust_badge: "Accredited KSA Practice +25 Years",
    ...
    hero_description_exact: "Senior Real Estate Development Director & Principal Architect with over 25 years of experience leading mega projects from design and master planning to turnkey execution and delivery across Saudi Arabia.",
    hero_btn_projects_exact: "Explore Projects",
    hero_btn_contact_exact: "Request Consultation",
    proof_exp: "+25 Years of Experience",
    ...
    timeline_tag: "CAREER ERA SCRUBBER • 1986 — 2024",
    timeline_title: "Leadership & Engineering Evolution Across 25 Years",
